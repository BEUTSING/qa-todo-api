    ...
    public function testCreateTodo(): void
{
    ...
    $result = $service->createTodo('Apprendre PHPUnit');

    $this->assertInstanceOf(Todo::class, $result); // le assertInstanceOf vérifie que l'objet retourné est bien une instance de la classe Todo.
